...
\geometry{left=1cm, top=0.5cm, right=1cm, bottom=0.5cm, footskip=.5cm}
...
\begin{flushleft}
	\textbf{Notable projects:}
		...
		\href{https://github.com/craciunoiuc/discord-bot}{Discord Golang Bot},
...
\begin{tabular}{rl}
	\textbullet \,\,\,\,\,\,\,\,\,\, Advanced Knowledge: & \textsc{Unix}-based systems, GitHub Actions, GoLang, Git, C/C++, Computer Networking \\
	\textbullet \, Intermediate Knowledge: & \textsc{Bash} scripting, Kubernetes, Java, OOP, Python, x86 Assembly, Kernel Programming \\
	\textbullet \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\enspace Basic Knowledge: & Algorithm Design \& Optimization, \LaTeX, Parallel Programming, CUDA, Haskell, C\#, SQL
\end{tabular}
...
\begin{tabular}{l|r}
	...
	\begin{tabular}{rl}
		\textbf{Soft Skills} & \\
		\textbullet \enspace & Good \& active team communication\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\\
		\textbullet \enspace & Excelent response to pressure \\
